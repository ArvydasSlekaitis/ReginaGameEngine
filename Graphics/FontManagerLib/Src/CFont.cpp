...
void CFont::GetTextExtent(const wstring& iText, RECT& oRect)
	{
	font->DrawText(NULL, iText.c_str(), iText.size(), &oRect, DT_CALCRECT, D3DCOLOR_XRGB(0,0,0));
	}
...
void CFont::DrawText(const wstring& iText, RECT iRect, DWORD iFormat, const D3DCOLOR& iColor)
	{
	font->DrawText(NULL, iText.c_str(), iText.size(), &iRect, iFormat, iColor);
	}
...
void CFont::DrawText(const wstring& iText, const D3DXVECTOR2& iPosition, const D3DCOLOR& iColor)
	...
	font->DrawText(NULL, iText.c_str(), iText.size(), &rc, DT_NOCLIP, iColor);
	}

//*****************************************************************************

void CFont::DrawText(LPD3DXSPRITE iSprite, const wstring& iText, const D3DXVECTOR2& iPosition, const D3DCOLOR& iColor)
	{
	RECT rc;
	rc.left = iPosition.x;
	rc.right = iPosition.x + 1;
	...
	font->DrawText(iSprite, iText.c_str(), iText.size(), &rc, DT_NOCLIP, iColor);
	}

//*****************************************************************************

void CFont::DrawText(LPD3DXSPRITE iSprite, const wstring& iText, RECT iRect, DWORD iFormat, const D3DCOLOR& iColor)
	{
	font->DrawText(iSprite, iText.c_str(), iText.size(), &iRect, iFormat, iColor);
	}
