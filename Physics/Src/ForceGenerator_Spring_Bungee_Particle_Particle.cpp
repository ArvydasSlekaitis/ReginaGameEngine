///////////////////////////////////////////////////////////
//  ForceGenerator_Spring_Bungee_Particle_Particle.cpp
...
void CForceGenerator_Spring_Bungee_Particle_Particle::Update(float iDuration)
{
assert(owner!=NULL); 
...
void CForceGenerator_Spring_Bungee_Particle_Particle::Load(string iDefinition)
{
